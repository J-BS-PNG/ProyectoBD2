...
// obtener un usuario especifico de la base por el correo
obtenerUsuarioPorEmail : (email, result) => {
    db.query("SELECT * FROM  usuario WHERE usuario_email = ?", [email], (err, results) =>{
        if(err){
            console.log(err);
            result(err, null);
        } else{
